...
Votre mission, si vous l'acceptez, est de calculer le Dynamic Habitat Index (DHI) à partir d'une série temporelle Sentinel-2 sur la forêt de Bouconne ([image](https://karasiak.net/data/students/SITS_2018_bouconne.tif) et [metadonnées](https://karasiak.net/data/students/SITS_2018_bouconne.tif.aux.xml) à télécharger)
